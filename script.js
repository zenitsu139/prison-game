...
function mainOne(){
		...
		div.onclick = ()=>{
			...
			if (breakk == 0) {	
					stone_breakk.play()
					if (div.style.background == 'url(images/stone.png)') {
					alert('stone')	
					point ++;
					point ++;
					point ++;
				...
				if (div.style.background == 'url(images/iron_ore.png)') {alert('iron')
						if (tool == 'stone_pickaxe' || tool == 'iron_pickaxe' || tool == 'diamond_pickaxe' || tool == 'netherite_pickaxe') {
							point ++;
							point ++;
							point ++;
							point ++;
				...
				if (div.style.background == 'url(images/iron_ore.png)') {
						if (tool == 'iron_pickaxe' || tool == 'diamond_pickaxe' || tool == 'netherite_pickaxe') {
							alert('gold')	
							point ++;
							point ++;
							point ++;
